...
namespace CorkscrewCoaster
{
    public class Main : IMod
    {
        ...
        public void onEnabled()
        {
            ...
            TwisterCoasterMeshGenerator trackGenerator = binder.RegisterMeshGenerator<TwisterCoasterMeshGenerator> (trackedRide);
            ...
            CoasterCarInstantiator coasterCarInstantiator = binder.RegisterCoasterCarInstaniator<CoasterCarInstantiator> (trackedRide, "CorkscrewCoasterInsantiator", "Corkscrew Car", 1, 10, 2);
            
            BaseCar frontCar =  binder.RegisterCar<BaseCar> ( AssetBundleManager.FrontCartGo,"CorkScrewCoaster_Front_Car", .35f,0f,true, new[] { 
            ...
            coasterCarInstantiator.frontVehicleGO.gameObject.AddComponent<RestraintRotationController>().closedAngles = new Vector3(90,0,0);

            BaseCar backCar =  binder.RegisterCar<BaseCar> ( AssetBundleManager.CartGo,"CorkScrewCoaster_Back_Car", .35f,-.3f,false, new[] { 
                new Color(71f / 255, 71f / 255, 71f / 255), 
                new Color(176f / 255, 7f / 255, 7f / 255), 
                new Color(26f / 255, 26f / 255, 26f / 255)}
            );
            coasterCarInstantiator.vehicleGO = backCar;
            coasterCarInstantiator.vehicleGO.gameObject.AddComponent<RestraintRotationController>().closedAngles = new Vector3(90,0,0);
